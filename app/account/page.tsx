...
export default function Account(){
  ...
  useEffect(()=>{void fetch("/api/auth/me",{cache:"no-store"}).then(async response=>{const body=await response.json() as MeResponse;setUser(body.user);setConfigured(body.configured)}).catch(()=>setConfigured(false))},[]);
